...
{
    /// <summary>
    /// VideoCaptureCameraInput 2 mat helper.
    /// v 1.0.0
    /// Depends on OpenCVForUnity version 2.6.1 (WebCamTexture2MatHelper v 1.0.0) or later.
        ...
        protected override IEnumerator _Initialize()
        {
            ...
            if (!String.IsNullOrEmpty(requestedDeviceName))
            {
                ...
                if (webCamTexture == null)
                    Debug.Log("VideoCaptureCameraInputToMatHelper:: " + "Cannot find camera device " + requestedDeviceName + ".");
            }
            ...
            if (webCamTexture == null)
            {
                ...
                else
                {
                    ...
                    if (onErrorOccurred != null)
                        onErrorOccurred.Invoke(Source2MatHelperErrorCode.CAMERA_DEVICE_NOT_EXIST, requestedDeviceName);
